...
router.patch('/changeStatusFromAdmin/:orderId', auth(endPoint.changeStatusFromAdmin), validation(validators.changeStatusFromAdmin), asyncHandler( orderController.changeStatusFromAdmin ) );
